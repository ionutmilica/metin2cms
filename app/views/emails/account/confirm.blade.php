...
<div>
    ...
    Confirmation link is: <a href="{{ route('account.register.confirm', array($login, $confirmation_token)) }}">
        {{ route('account.register.confirm', array($login, $confirmation_token)) }}
    </a> <br/>
